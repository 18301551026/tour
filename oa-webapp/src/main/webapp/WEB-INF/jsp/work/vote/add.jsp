		...
		<table class="formTable table">
			...
			<Tr>
				...
				<Td class="query_input" colspan="3"><s:textfield
						...
						placeholder="请输入投票选项" cssStyle="width:95%;margin-bottom: 2px"></s:textfield> <input
					class="btn btn-info btn-xs pull-right" id="addOption" value="添加" style="margin-top: 2px;"
					type="button" /></Td>
			</Tr>
			<Tr>
