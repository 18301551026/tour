				...
				buttons : [
						{
							...
							handler : function() {
								var f = parent.$.modalDialog.handler
										.find('#chartForm');
								f.attr("action",ctx+"/tour/sameCompareQuaterReport!districtQuarterHtmlReport.action")
								f.submit();
							}
						}, {
							text : 'word导出',
							...
							handler : function() {
								var f = parent.$.modalDialog.handler
								.find('#chartForm');
								f.attr("action",ctx+"/tour/sameCompareQuaterReport!districtQuarterWordReport.action")
								f.submit();
							}
						}, {
							text : '取消',
			...
			<tbody>
				...
				<s:iterator value="#page.result">
					<tr>
						...
						<td><a 
							href="${ctx }/tour/districtQuarterSameCompare!sameCompareToDetail.action?nowIds=${nowIds}&lastIds=${lastIds}&tempReportDate=${year}年${quarter}">详情</a></td>
					</tr>
				</s:iterator>
			</tbody>
		</table>
